        ...
        <div className="row">
          ...
          <div className="col-10 content">
            <div className='w-100 rounded bg-white border shadow p-4'>
              <h4>Gitds-Admin Page</h4>
              <div className='d-flex justify-content-end'>
                <Link to="/gitds/create" className='btn btn-success'> Add +</Link>
              </div>
                ...
                <tbody>
                  {data.map((d) => (
                    <tr key={d.id}>
                      ...
                      <td>{d.address}</td>
                      <td>
                        <Link to={`/gitds/read/${d.id}`} className='btn btn-sm btn-info' style={{ marginRight: '8px' }}>Details</Link>
                        <Link to={`/gitds/update/${d.id}`} className='btn btn-sm btn-primary' style={{ marginRight: '8px' }}>Edit</Link>
