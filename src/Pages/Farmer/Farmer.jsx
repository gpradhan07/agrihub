          ...
          <div className="col-10 content">
              ...
              <h4>Farmer Page</h4>
                <div className='d-flex justify-content-end'>
                  <Link to="/farmer/create" className='btn btn-success'> Add +</Link>
                </div>
                  ...
                  <tbody>
                    {
                      data.map((d, i) => (
                        <tr key={i}>
                          ...
                          <td>{d.address}</td>
                          <td>
                            <Link to={`/farmer/read/${d.id}`} className='btn btn-sm btn-info'  style={{ marginRight: '8px' }}>Details</Link>
                            <Link to={`/farmer/update/${d.id}`} className='btn btn-sm btn-primary'  style={{ marginRight: '8px' }}>Edit</Link>
