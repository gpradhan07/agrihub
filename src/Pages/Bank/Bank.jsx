          ...
          <div className="col-10 content">
              ...
              <h4>Bank Page</h4>
                <div className='d-flex justify-content-end'>
                  <Link to="/bank/create" className='btn btn-success'> Add +</Link>
                </div>
                  ...
                  <tbody>
                    {
                      data.map((d, i) => (
                        <tr key={i}>
                          ...
                          <td>{d.district}</td>
                          <td>
                            <Link to={`/bank/read/${d.id}`} className='btn btn-sm btn-info'  style={{ marginRight: '8px' }}>Deatils</Link>
                            <Link to={`/bank/update/${d.id}`} className='btn btn-sm btn-primary'  style={{ marginRight: '8px' }}>Edit</Link>
